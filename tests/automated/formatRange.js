...
describe('formatRange', function() {
	...
	it('doesn\'t do any splitting when dates have different years', function() {
		var s = $.njCalendar.formatRange('2014-01-01', '2015-01-01', 'MMMM Do YYYY');
		expect(s).toEqual('January 1st 2014 - January 1st 2015');
	});

	it('splits correctly on day when dates have same month', function() {
		var s = $.njCalendar.formatRange('2014-01-01', '2014-01-05', 'MMMM Do YYYY');
	...
	it('splits correctly on day when dates have same month and smaller unit in front', function() {
		var s = $.njCalendar.formatRange('2014-01-01', '2014-01-05', 'dddd MMMM Do YYYY');
	...
	it('splits correctly on the time when dates have the same day', function() {
		var s = $.njCalendar.formatRange('2014-01-01T06:00:00', '2014-01-01T08:00:00', 'MMMM Do YYYY h:mma');
	...
	it('splits correctly on the time when dates have the same day and hour but different am/pm', function() {
		var s = $.njCalendar.formatRange('2014-01-01T06:00:00', '2014-01-01T18:00:00', 'MMMM Do YYYY h:mma');
	...
	it('splits correctly on the time when the dates have the same hour', function() {
		var s = $.njCalendar.formatRange('2014-01-01T06:00:00', '2014-01-01T06:30:00', 'MMMM Do YYYY h:mma');
	...
	it('outputs the single date when the dates have the same day and time', function() {
		var s = $.njCalendar.formatRange('2014-01-01T06:00:00', '2014-01-01T06:00:00', 'MMMM Do YYYY h:mma');
	...
	it('outputs the single date when the dates have the same day and the format string is vague', function() {
		var s = $.njCalendar.formatRange('2014-01-01', '2014-01-01', 'MMMM Do YYYY');
		expect(s).toEqual('January 1st 2014');
	});

	it('uses a custom separator', function() {
		var s = $.njCalendar.formatRange(
			'2014-01-01T06:00:00',
			'2014-01-01T06:30:00',
			'MMMM Do YYYY h:mma',
			'<...>'
	...
	describe('when called with isRTL', function() {
		...
		it('doesn\'t do any splitting when dates have different years', function() {
			var s = $.njCalendar.formatRange('2014-01-01', '2015-01-01', 'MMMM Do YYYY', null, true);
			expect(s).toEqual('January 1st 2015 - January 1st 2014');
		});

		it('splits correctly on day when dates have same month', function() {
			var s = $.njCalendar.formatRange('2014-01-01', '2014-01-05', 'MMMM Do YYYY', null, true);
			expect(s).toEqual('January 5th - 1st 2014');
		});

		it('splits correctly on day when dates have same month and smaller unit in front', function() {
			var s = $.njCalendar.formatRange('2014-01-01', '2014-01-05', 'dddd MMMM Do YYYY', null, true);
			expect(s).toEqual('Sunday January 5th - Wednesday January 1st 2014');
		});

		it('splits correctly on the time when dates have the same day', function() {
			var s = $.njCalendar.formatRange('2014-01-01T06:00:00', '2014-01-01T08:00:00', 'MMMM Do YYYY h:mma', null, true);
			expect(s).toEqual('January 1st 2014 8:00am - 6:00am');
		});

		it('splits correctly on the time when dates have the same day and hour but different am/pm', function() {
			var s = $.njCalendar.formatRange('2014-01-01T06:00:00', '2014-01-01T18:00:00', 'MMMM Do YYYY h:mma', null, true);
			expect(s).toEqual('January 1st 2014 6:00pm - 6:00am');
		});

		it('splits correctly on the time when the dates have the same hour', function() {
			var s = $.njCalendar.formatRange('2014-01-01T06:00:00', '2014-01-01T06:30:00', 'MMMM Do YYYY h:mma', null, true);
			expect(s).toEqual('January 1st 2014 6:30am - 6:00am');
		});

		it('outputs the single date when the dates have the same day and time', function() {
			var s = $.njCalendar.formatRange('2014-01-01T06:00:00', '2014-01-01T06:00:00', 'MMMM Do YYYY h:mma', null, true);
			expect(s).toEqual('January 1st 2014 6:00am');
		});

		it('outputs the single date when the dates have the same day and the format string is vague', function() {
			var s = $.njCalendar.formatRange('2014-01-01', '2014-01-01', 'MMMM Do YYYY', null, true);
			expect(s).toEqual('January 1st 2014');
		});
