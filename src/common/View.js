...
var View = fc.View = Class.extend({
	...
	*/
	...
	eventDrop: function(el, event, newStart, ev, ui) {
	...
	// - row, col
	// - { row:#, col:# }
	cellToCellOffset: function(row, col) {
	...
	cellOffsetToDayOffset: function(cellOffset) {
	...
	// day offset -> date
	dayOffsetToDate: function(dayOffset) {
	...
	// date -> day offset
	dateToDayOffset: function(date) {
		return date.clone().stripTime().diff(t.start, 'days');
	},

	// day offset -> cell offset
	dayOffsetToCellOffset: function(dayOffset) {
		var day0 = t.start.day(); // first date's day of week
	...
	cellOffsetToCell: function(cellOffset) {
		var colCnt = t.colCnt;
